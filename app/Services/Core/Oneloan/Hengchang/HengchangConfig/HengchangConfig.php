...
{
    //地址
    const URL = PRODUCTION_ENV ? 'http://crm.credithc.com' : 'http://118.26.170.17:8086';

    //用户名
    const USERNAME = 'jdt';
    //密码
    const PASSWORD = 'S7XBy3TJWJDVs';
    //渠道号
    const QUDAOHAO = 28;
    //加密key
    const JPASSWORD = 'FkwTwfDFiZ5Fr';
    //code
    const HENGCHANG_CODE = 'jdt_001';
